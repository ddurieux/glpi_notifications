...
##ENDFOREACHtasks##
   ...
   <table style="border-collapse: collapse;width: 950px; border-bottom-left-radius: 6px;border-bottom-right-radius: 6px;background-color: #1B2F62;color: white;height: 80px;">
    <tr style="height: 25px">
      <td style="width:160px" rowspan="2">
      </td>
      <td style="width:778px;height: 30px;font-size: 16px;">
